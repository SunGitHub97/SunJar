...
public class ConvertUtil {
     ...
     * @return
     */
    public static String bytesToString(byte[] ss) {
	 ...
	 * @return
	 */
	public static String int10To43(int intVal) {
		return int10ToAnyIn42(intVal, C_CODES_STRING.length());
	}
	
	/***
	 * 将10进制转换为任意进制
	 * @param intVal  要转换的10进制
	 * @param base  <=42  小于等于43进制
	 * @return  失败返回null
	 */
	public static String int10ToAnyIn42(long intVal, int base) {
		try {
			if(base > 42) {
				return null;
			}
	 ...
	 * @return  失败返回null
	 */
	public static String IntToAnyIn42(String s, int srcBase, int destBase) {
		try {
			if(srcBase > 42 || destBase>42) {
				return null;
			}
			...
			return int10ToAnyIn42(Integer.valueOf(s), destBase);
		}catch (Exception e) {
			return null;
		}
	}
	 ...
	 * 获取某个类型的默认值
	 * @param obj            传输对象
	 * @param exampleClass   对象的类
	 * @return
	 *   1、若obj为null,exampleClass也为null,则返回null
	 *   2、若obj为null，exampleClass不为null,则返回exampleClass中类的默认值
	 *   3、若obj不为null,则返回obj,与exampleClass无关
	 *   
	 *   例子 baseDefult(1,Integer.class)、baseDefult(1,null)  返回1
	 *       baseDefult(null,Double.class)  返回0.0
	 *       baseDefult(null,null)  返回null
	 */
	public static Object baseDefult(Object obj,Class<?> exampleClass) {
		
		if(exampleClass != null && (obj == null || obj == "")) {
			if(exampleClass == Integer.class || exampleClass == Short.class || exampleClass == Byte.class || exampleClass == Long.class) {
				return 0;
			}else if(exampleClass == Double.class || exampleClass == Float.class) {
				return 0.0;
			}else if( exampleClass == String.class || exampleClass == Character.class ) {
				return "";
			}else if(exampleClass == Boolean.class) {
				return false;
			}else if(exampleClass == BigDecimal.class) {
				return new BigDecimal(0);
			}
			return obj;
		}else if(exampleClass == null && obj == null){
			return null;
		}else {
			return obj;
		}
